...
def filter_by_request_params(
    request: HttpRequest, queryset: QuerySet, allowed_filters=[]
) -> QuerySet:
...
def create_pagable_list_response(
    request: HttpRequest, queryset: QuerySet, serializer: serializers.ModelSerializer
):
